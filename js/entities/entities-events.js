...
function initHeaderButtons() {
    ...
    if (btnMarketplaceAdmin) {
        btnMarketplaceAdmin.addEventListener('click', () => {
            console.log('🛒 Відкриваємо адмін маркетплейсів...');
            // TODO: Відкрити модалку адміністрування маркетплейсів
            alert('Адмін маркетплейсів (в розробці)');
        });
    }
...
function initRowSelection() {
    const entityContent = document.querySelector('.entity-content');
    if (!entityContent) return;
...
function initRowDoubleClick() {
    ...
    entityContent.addEventListener('dblclick', (e) => {
