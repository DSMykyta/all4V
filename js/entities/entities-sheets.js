...
export async function createMarketplaceSheets(marketplaceId, columnsConfig) {
    ...
    try {
        ...
        // Categories headers: ['local_id', ...custom columns]
        const categoriesHeaders = ['local_id', ...(columnsConfig.categories || [])];
        headerRequests.push({
        ...
        const characteristicsHeaders = ['local_id', ...(columnsConfig.characteristics || [])];
        headerRequests.push({
        ...
        // Options headers
        const optionsHeaders = ['local_id', ...(columnsConfig.options || [])];
        headerRequests.push({
